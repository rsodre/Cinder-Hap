...
CinderHap enables the Hap codec on [Cinder](http://github.com/cinder/Cinder).
...
Hap was developed by [Tom Butterworth](https://twitter.com/bang_noise) for [Vidvox](http://vidvox.net/). For general information about Hap, see [the Hap project](http://github.com/vidvox/hap).
